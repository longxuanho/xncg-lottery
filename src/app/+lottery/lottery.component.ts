    ...
    this.subscriptions.lotterySettings = this.lotterySettingsService.getSettings()
      ...
      (value: LotterySettings) => {
        ...
        if (this.lotterySettings) {
          $('body').removeClass('has-background-image-1 has-background-image-2 has-background-image-3 has-background-image-4 has-background-image-5 has-background-image-6');
